            ...
            return (
              <div className="flex w-full h-auto p-3 justify-start cursor-pointer hover:shadow-2xl hover:text-blue-400">
                ...
                <div className="flex flex-col w-1/3 pl-5">
                  <div className="h-12 w-full font-semibold text-base cursor-pointer">{item.title}</div>
                  <div className="text-gray-500 mt-1 text-base hover:text-blue-500">
                    <UserOutlined />
                ...
                <div className="flex flex-col justify-start w-1/3">
                  ...
                  <div className="flex flex-col justify-center h-2/3">
                    <div className="text-center text-xl text-indigo-400 font-semibold">{item.score}</div>

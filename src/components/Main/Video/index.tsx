...
import type { videoItem } from '@/models/main'
    ...
    <div className="flex w-full h-auto mt-6 pb-12 pl-56 overflow-auto bg-white">
      <div className="flex flex-col w-2/3">
        ...
        <iframe
          ...
          title={video.title}
        />
        <div className="flex justify-start p-1 mt-3 h-auto w-full border-b border-solid border-t-0 border-l-0 border-r-0 border-gray-200">
        ...
        <div className="mt-2 ml-2 text-sm overflow-auto w-full" style={{ WebkitLineClamp: 2 }}>{video.desc}</div>
      </div>
    </div>
  )
}
